...
const Generate = () => {
  ...
  // if the url has no id and thumbnail exist so remove the old thumbnail
  useEffect(() => {
    if (!id && thumbnail) {
      setThumbnail(null);
    }
              ...
              <div className="p-6 rounded-2xl bg-white/8 border border-white/12 shadow-xl space-y-6">
                ...
                {!id && (
                  <button
                    ...
                    className="text-[15px] w-full py-3.5 rounded-lg font-medium bg-linear-to-b from-pink-500 to-pink-600 hover:from-pink-600 hover:to-pink-700 disabled:cursor-not-allowed transition-colors"
                  >
